...
const CREDENCIALES = [
  ...
  {
    email: "mesero@lamesadorada.com",
    password: "mesero123",
    rol: "Mesero",
  },

  {
    email: "cocina@lamesadorada.com",
    password: "cocina123",
    rol: "Cocinero",
  },
];
      ...
      <div className="login-hero">
        ...
        <div className="login-hero-inner">
          ...
          <p className="login-hero-desc">
            Sistema de gestión interno para
            el control de personal, mesas y
            pedidos.
          </p>
      ...
      <div className="login-form-panel">
        ...
        <div className="login-form-inner">
          ...
          <div className="login-form-logo">
            ...
            <span className="login-form-logo-icon">
              🍴
            </span>

            <span className="login-form-logo-name">
              La Mesa Dorada
            </span>
